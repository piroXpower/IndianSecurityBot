...
BUTTON = [[Button.url("Sᴜᴘᴘᴏʀᴛ", "https://t.me/tgnofficialbots"), Button.url("UᴘDᴀᴛᴇ", "https://t.me/tgnbots")]]
...
async def hmm(yes):
    ...
    pm_caption += "**♡ My Team :** [TGN](https://t.me/tgnbots)\n"
    BUTTON = [[Button.url("Support", "https://t.me/tgnofficialbots"), Button.url("UpDate", "https://t.me/tgnbots")]]
